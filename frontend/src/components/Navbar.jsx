  ...
  return (
    <header className="h-[48px] bg-[#F7F6F2] border-b border-black/5 flex items-center justify-between px-[41px] sticky top-0 z-50">
      <div 
        ...
        className="cursor-pointer flex items-center gap-2.5 text-[25px] tracking-tight font-bold select-none"
      >
      ...
      <div className="flex items-center gap-4 relative" ref={dropdownRef}>
        ...
        {!loggedIn ? (
          <button
            ...
            className="px-4 h-[35px] rounded-xl bg-[#E8AE3F] hover:bg-amber-600 text-white text-xs font-semibold transition shadow-sm cursor-pointer"
          >
            Sign In
          </button>
        ) : (
